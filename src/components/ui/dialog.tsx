  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // CORREÇÃO 1: Fundo e Opacidade Forçada
          "!bg-white dark:bg-gray-900 !opacity-100", // CORREÇÃO 2: Adicionando transform-none e shadow-2xl para forçar a renderização
