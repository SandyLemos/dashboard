            ...
            <div className="absolute top-14 right-0 w-64 bg-white rounded-2xl shadow-2xl p-5 border border-gray-100 animate-in fade-in zoom-in-95 duration-200">
              <div className="flex items-center gap-4 pb-4 border-b border-gray-100 mb-2">
                ...
                <div className="flex flex-col text-left overflow-hidden">
                  <strong className="text-sm text-black truncate">{userData.name}</strong>
              ...
              <ul className="flex flex-col gap-1">
                <li>
                  <Link to="/account" className="flex items-center gap-3 p-2.5 text-gray-700 bg-gray-50 rounded-lg font-medium">
        ...
        <div className="bg-white w-full max-w-[500px] p-8 md:p-10 rounded-3xl shadow-2xl">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="space-y-2">
              <label className="text-[#4B0082] font-bold text-sm ml-1">Nome</label>
            ...
            {/* Campo Email */}
            <div className="space-y-2">
              <label className="text-[#4B0082] font-bold text-sm ml-1">E-mail</label>
              <div className="relative group">
                <input
                  type="email"
            ...
            {/* Campo Senha */}
            <div className="space-y-2">
              <label className="text-[#4B0082] font-bold text-sm ml-1">Senha</label>
              <div className="relative group">
                <input
                  type="password"
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              <div className="flex flex-col gap-2">
                <span className="text-sm text-gray-500">Gerenciamento de conta</span>
