    ...
    <div className="min-h-screen bg-[#dae4f8] pb-10 flex flex-col items-center">
      ...
      <main className="w-[95%] max-w-[1200px] mt-8">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="text-3xl font-bold text-black font-serif">Ingressos</h1>
        </div>
        ...
        <div className="min-h-[300px]">
          {activeTab === "Ativos" ? (
              ...
              {myTickets.map((ticket) => (
                ...
                >
                  ...
                  <div className="w-full md:w-[200px] h-[140px] flex-shrink-0 rounded-2xl overflow-hidden relative">
                    <img src={ticket.imageSrc} alt={ticket.title} className="w-full h-full object-cover" />
                  </div>
                  ...
                  <div className="flex-grow text-center md:text-left w-full">
                    ...
                    <h3 className="text-lg font-extrabold text-gray-900 mb-1">{ticket.title}</h3>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start text-xs text-gray-600">
                      <span className="flex items-center gap-1"><MapPin className="w-3 h-3 text-[#7b2cbf]" /> {ticket.location}</span>
                      <span className="flex items-center gap-1"><Calendar className="w-3 h-3 text-[#7b2cbf]" /> {ticket.date}</span>
                    </div>
                  </div>
                  ...
                  <div className="w-full md:w-auto flex-shrink-0 flex flex-col items-center md:items-end gap-3 px-4">
                    <div className="bg-[#F3F0FA] px-4 py-2 rounded-lg flex items-center gap-2">
                      ...
                      <div className="text-right">
                        <span className="block text-xs font-bold text-gray-800">{ticket.type}</span>
                        <span className="block text-[10px] text-green-600 font-bold uppercase">Confirmado</span>
                      </div>
                    </div>
                    <Link 
                      to={`/event-details/${ticket.id}`} 
            ...
            <div className="bg-[#e8efff] rounded-3xl h-[400px] flex flex-col items-center justify-center gap-6 shadow-inner">
              <p className="text-gray-500 text-lg font-medium">Não há ingressos nesta categoria</p>
              <Link 
                to="/events" 
